...
| server    | port | location   | note       |
|-----------+------+------------+------------|
| primary   |  443 | /          |            |
| secondary | 5010 | /secondary | irrelevant |
| apiary    | 5010 | /apiary    |            |
...
http://localhost:3001 irrelevant
...
https://localhost:5010/secondary irrelevant
...
**** trying two origins
file:~/Programming/Rails/corsed_project/apiary/config/initializers/cors.rb::1
...
** Question
So is it a matter of finding the attempted origins in the browser and adding the
