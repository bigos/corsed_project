...
var $author$project$Hello$Loading = {$: 'Loading'};
var $author$project$Hello$GotQuote = function (a) {
	return {$: 'GotQuote', a: a};
};
...
var $author$project$Hello$Failure = {$: 'Failure'};
var $author$project$Hello$Success = function (a) {
	return {$: 'Success', a: a};
};
		...
		if (msg.$ === 'MorePlease') {
			...
			if (result.$ === 'Ok') {
				...
				return _Utils_Tuple2(
					$author$project$Hello$Success(quote),
					$elm$core$Platform$Cmd$none);
			} else {
				return _Utils_Tuple2($author$project$Hello$Failure, $elm$core$Platform$Cmd$none);
			}
		}
	});
...
var $author$project$Hello$MorePlease = {$: 'MorePlease'};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Hello$MorePlease)
							]),
						_List_fromArray(
							[
